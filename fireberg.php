 ...
 *
 * @wordpress-plugin
 * Plugin Name:  Gutenberg <=> Firebase Integration Example
 * Plugin URI:   https://www.alainschlesser.com
 * Description:  Example plugin to demonstrate a use case for integrating Google Firebase with Gutenberg.
 * Version:      0.1.0
 * Requires PHP: 7.2
 * Author:       Alain Schlesser <alain.schlesser@gmail.com>
 * Author URI:   https://www.alainschlesser.com/
 * Text Domain:  fireberg
 ...
 * implementation. This allows us to just use the plugin as-is without requiring
